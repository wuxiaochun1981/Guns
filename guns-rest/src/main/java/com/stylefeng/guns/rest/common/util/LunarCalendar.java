 ...
 * <p>
 * <p>
 * Copyright: Copyright (c) 2018/3/21 19:22
 * <p>
 * Company: 京东
 * <p>
 *
...
public class LunarCalendar {
    ...
    private void CalculateLunarCalendar(int y, int m, int d) {
        ...
        System.out.println("计算=" + sTerm(y, (m - 1) * 2));
        System.out.println("计算1=" + sTerm(y, (m - 1) * 2 + 1));
        if (d == sTerm(y, (m - 1) * 2))
            ...
            solarTerms = "";
        System.out.println("solarTerms=" +solarTerms);
        //计算公历节日
        this.solarFestival = "";
    ...
    public static String getChinaDayString(int day) {
        ...
        if (day == 10)
            ...
            return chineseTen[day / 10] + chineseMonthNumber[n];
    }
    ...
    public String getMonthAndDay(){
        return (leap ? "闰" : "") + chineseMonthNumber[lmonth - 1] + "月" + getChinaDayString(lday);
    }
